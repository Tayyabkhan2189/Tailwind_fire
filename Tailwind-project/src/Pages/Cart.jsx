      ...
      <div className="container mx-auto mt-10">
        <div className="flex shadow-md my-10">
          <div className="w-3/4 bg-white px-10 py-10">
            ...
            <Link to="/about" className="flex font-semibold text-indigo-600 text-sm mt-10">
          ...
          <div id="summary" className="w-1/4 px-8 py-10">
            ...
            <div className="flex justify-between mt-10 mb-5">
              <span className="font-semibold text-sm uppercase">Items {product.reduce((acc, item) => acc + item.quantity, 0)}</span>
            ...
            <div className="border-t mt-8">
             ...
             <Link to="https://buy.stripe.com/test_aEUbJh2zi3Tn9G06oo"> <button className="bg-indigo-500 font-semibold hover:bg-indigo-600 py-3 text-sm text-white uppercase w-full">Checkout</button></Link>
            </div>
          </div>
        </div>
      </div>
